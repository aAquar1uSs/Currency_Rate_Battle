...
{
    public override Task<List<RateDal>> Handle(List<RateDal> rates)
    {
    ...
    private void StandartCalculation(ref List<RateDal> rates, decimal commonBank)
    {
    ...
    private void UnusualCalculation(ref List<RateDal> rates, decimal commonBank)
    {
    ...
    private bool CheckSameRates(List<RateDal> rates)
    {
